...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <meta name='application-name' content='everything marketplace' />
        <meta name='apple-mobile-web-app-capable' content='yes' />
        <meta name='apple-mobile-web-app-status-bar-style' content='default' />
        <meta name='apple-mobile-web-app-title' content='everything' />
        <meta name='description' content='Marketplace for the inventory of everything' />
        ...
        <meta name='twitter:description' content='Marketplace for the inventory of everything' />
        ...
        <meta property='og:description' content='Marketplace for the inventory of everything' />
